package com.primeiroprojeto.myFirstWebApi.Repository;

import com.primeiroprojeto.myFirstWebApi.Handler.CampoObrigatorio;
...
public class UsuarioRepository {
    ...
    public List<Usuario> findAll(){
        ...
        usuarios.add(new Usuario("Vitoria", "masterpassewor"));
        return usuarios;
    }
